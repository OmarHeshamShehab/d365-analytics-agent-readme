...
flowchart TB
    ...
    subgraph D365["D365 Sales Analytics Agent"]
        T1["✔ <b>Data Source Transparency</b><br/>Shows exact SQL for every numeric result"]
        T2["✔ <b>Numeric Accuracy</b><br/>Zero hallucinations — SQL is the source of truth"]
        T3["✔ <b>Execution Mode</b><br/>Hybrid SQL → RAG → LLM (explainable)"]
        T4["✔ <b>Customizability</b><br/>SQL templates, synonyms, routing, thresholds"]
        T5["✔ <b>Local Execution</b><br/>GPU accelerated"]
        T6["✔ <b>100% Privacy</b><br/>No cloud dependency"]
        T7["✔ <b>Developer-controlled LLM</b><br/>DeepSeek R1 (Ollama)"]
        T8["✔ <b>Transparent Embeddings</b><br/>ChromaDB"]
        T9["✔ <b>Full Explainability</b><br/>SQL + reasoning chain"]
        T10["✔ <b>Error Handling</b><br/>Never fabricates missing data"]
        T11["✔ <b>Performance</b><br/>GPU-accelerated PyTorch"]
        T12["✔ <b>Offline Capable</b>"]
        T13["✔ <b>Data Validation</b><br/>USMF → SalesOrderHeadersV2"]
        T14["✔ <b>Observability</b><br/>SQL logs, vector logs, tests"]
        T15["✔ <b>Extensible</b><br/>New datasets, LLMs, pipelines"]
        T16["✔ <b>Test Framework</b><br/>Full pytest suite"]
        T17["✔ <b>Focus</b><br/>Analytical correctness + transparency"]
    end

    subgraph COP["Microsoft Copilot for D365"]
        C1["✖ SQL paths hidden — opaque reasoning"]
        C2["✖ May infer or approximate numeric results"]
        C3["✖ Single opaque LLM chain"]
        ...
        C10["✖ May reframe SQL gaps instead of returning empty result sets"]
        C11["✖ Depends on Microsoft compute latency"]
        C12["✖ No offline support"]
        C13["✖ Hard to validate outputs"]
        C14["✖ Limited observability"]
        C15["✖ Not extensible"]
        C16["✖ No testing hooks"]
        C17["✖ Focus: productivity + natural language"]
    end
